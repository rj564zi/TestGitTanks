...
var interval;
var Obtiaznost = "Obtiaznost"
var odpal = false;
var nabojtf = false;
var print = false;

var ammo = "Player1 Ammo: "
var stavodpocet ="Prebijam"
var municia = 20;
var silaNaboja = 100
var speed = 0.60;

var rychlostPrebijania = 2000;
var stavodpocett2 ="Prebijam"
var municiat22 = 20;
var odpocet22 = false;
...
/////////////////////////////////////////////
   ...
   if(prepinacT1 ===false){
    ...
    if(print===true&&hP <=0){
        scene.remove(podvozok);
        Obtiaznost="Player1 win stlac B a hraj znova"
        resett=true;
        print=false;
    ...
    if(zasahTanku1===true&&hP2<=0){
            ...
            scene.remove(cube1);
            Obtiaznost="Player2 win stlac B a hraj znova"
            resett = true;
            zasahTanku1=false;
    ...
    if(hpPrepinac === true&&hpPrepinac2===true){
        setTimeout(zivot,1000);
        hpPrepinac2=false
    }
    if(hpPrepinact2 ===true&&hpPrepinac2t2===true){
        setTimeout(zivot2,1000);
        hpPrepinac2t2=false
    }
...
function t34(){
   ...
   //  var geometryPlaneeeeass = new THREE.PlaneGeometry( -0.82, 0.89,4 , 4 );
   //  //var planeTexturee = new THREE.ImageUtils.loadTexture('texture/carbon.png')
   //  var materialPlaneeeeass = new THREE.MeshBasicMaterial( {color: 0x000000, side: THREE.DoubleSide} );
   //  predok= new THREE.Mesh( geometryPlaneeeeass, materialPlaneeeeass );
   //  predok.position.set(0, 0.4, -0.00004);
   // // predok.position.set(0, 1.89, 0.49);
   //  //predok.rotation.x = Math.PI / 2;
   //  //cube2.rotation.x = Math.PI / 2;
   //  scene.add(predok);

   // cube4.add(circle,cube5,cube6,circle2,circle3,strela)
